...
推荐使用Vercel部署，本项目主要修改均基于Vercel的部署场景。

## 安装


```shell
$ git clone https://github.com/Oecxuan/NeteaseCloudMusicApi.git
...
5. 在项目设置中添加自己的域名并解析，即可使用自己的域名访问。

## 腾讯云 serverless 部署（由于腾讯云由于API 网关产品计划于 2025年6月30日停止服务，此方法已经失效）
